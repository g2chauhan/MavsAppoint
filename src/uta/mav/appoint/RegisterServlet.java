...
import uta.mav.appoint.security.RandomPasswordGeneratorUtil;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			try{
				...
				String password =RandomPasswordGeneratorUtil.randomString(13);
				...
				studentUser.setStudentId(student_Id.toString());
